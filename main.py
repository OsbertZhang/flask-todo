...
app = Flask(__name__)
#app.secret_key = b'\x9d\xb1u\x08%\xe0\xd0p\x9bEL\xf8JC\xa3\xf4J(
# hAh\xa4\xcdw\x12S*,u\xec\xb8\xb8'
...
def incomplete_tasks():
    ...
    # If the request method is POST
        # Then retrieve the username from the session and find the associated
        # user
        # Retrieve the task_id from the form submission and use it to find
        # the associated task
        # Update the task to indicate that it has been completed at
        # datetime.now() by the current user # Retrieve a list of all incomplete tasks
